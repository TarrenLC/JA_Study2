...
library(tidyverse) # To tiday up data
...
tidydf3 <- select(tidydf2, DASS3:PRE_CONFIDENCE, EMO_REG_EFFORT1:est2_12_advice, AGE, EDU, CURRENT_HEALTH) #create a new dataset with the columns you want to convert, use : to specify "from column x to column y"
tidydf3 <- lapply(tidydf3, function(x) as.numeric(as.character(x)))
...
tidydf5 <- tidydf4[-c(15, 17, 33, 44, 46, 54, 75, 89)]
