...
nacount1 <- df6 %>%
  ...
  select(AGEGROUP, ESTTASK1_1n, ESTTASK1_2n, ESTTASK1_3n, ESTTASK1_4n, 
         ...
         ESTTASK1_10n, ESTTASK1_11n, ESTTASK1_12n) %>% # replace to your needs
  summarise_all(funs(sum(is.na(.))))
...
nacount1_prac <- df6 %>%
  group_by(AGEGROUP) %>%  
  select(AGEGROUP, PRAC1_1n, PRAC1_2n, PRAC1_3n) %>% # replace to your needs
  summarise_all(funs(sum(is.na(.))))
...
young <- young %>%
  mutate(JAR01_WOA = ifelse(is.na(JAR01_WOA), NA,
                             ifelse(JAR01_WOA > 2.055, 100, JAR01_WOA)),
         JAR01_WOA = ifelse(is.na(JAR01_WOA), NA,
                             ifelse(JAR01_WOA < -0.411, -100, JAR01_WOA))) ## 1 outlier
...
young <- young %>%
  mutate(JAR04_WOA = ifelse(is.na(JAR04_WOA), NA,
                             ifelse(JAR04_WOA > 1.800, 100, JAR04_WOA)),
         JAR04_WOA = ifelse(is.na(JAR04_WOA), NA,
                             ifelse(JAR04_WOA < -0.426, -100, JAR04_WOA))) ## 1 outlier
...
young <- young %>%
  mutate(JAR01_WOA = ifelse(is.na(JAR01_WOA), NA,
                             ifelse(JAR01_WOA == 100, 1.741, JAR01_WOA)),
         JAR01_WOA = ifelse(is.na(JAR01_WOA), NA,
                             ifelse(JAR01_WOA == -100, -0.011, JAR01_WOA)),
         JAR02_WOA = ifelse(is.na(JAR02_WOA), NA,
         ...
         JAR04_WOA = ifelse(is.na(JAR04_WOA), NA,
                             ifelse(JAR04_WOA == 100, 1.706, JAR04_WOA)),
         JAR04_WOA = ifelse(is.na(JAR04_WOA), NA,
                             ifelse(JAR04_WOA == -100, -0.280, JAR04_WOA)),
         JAR05_WOA = ifelse(is.na(JAR05_WOA), NA,
...
middle <- middle %>%
  mutate(JAR01_WOA = ifelse(is.na(JAR01_WOA), NA,
                             ifelse(JAR01_WOA > 1.477, 100, JAR01_WOA)),
         JAR01_WOA = ifelse(is.na(JAR01_WOA), NA,
                             ifelse(JAR01_WOA < 0.361, -100, JAR01_WOA))) ## No outliers
...
middle <- middle %>%
  mutate(JAR04_WOA = ifelse(is.na(JAR04_WOA), NA,
                             ifelse(JAR04_WOA > 2.128, 100, JAR04_WOA)),
         JAR04_WOA = ifelse(is.na(JAR04_WOA), NA,
                             ifelse(JAR04_WOA < -0.680, -100, JAR04_WOA))) ## 1 outlier
...
sum(middle$JAR01_WOA <= -100|middle$JAR02_WOA <= -100|middle$JAR03_WOA <= -100|
      middle$JAR04_WOA <= -100|middle$JAR05_WOA <= -100|middle$JAR06_WOA <= -100|
      middle$JAR07_WOA <= -100|middle$JAR08_WOA <= -100|middle$JAR09_WOA <= -100|
      middle$JAR10_WOA <= -100|middle$JAR11_WOA <= -100|middle$JAR12_WOA <= -100, na.rm=TRUE)

## It says 5 but I thought there were 6...?

# Replace the values taken

middle <- middle %>%
  mutate(JAR01_WOA = ifelse(is.na(JAR01_WOA), NA,
                             ifelse(JAR01_WOA == 100, 1.477, JAR01_WOA)),
         JAR01_WOA = ifelse(is.na(JAR01_WOA), NA,
                             ifelse(JAR01_WOA == -100, 0.361, JAR01_WOA)),
         JAR02_WOA = ifelse(is.na(JAR02_WOA), NA,
         ...
         JAR04_WOA = ifelse(is.na(JAR04_WOA), NA,
                             ifelse(JAR04_WOA == 100, 1.901, JAR04_WOA)),
         JAR04_WOA = ifelse(is.na(JAR04_WOA), NA,
                             ifelse(JAR04_WOA == -100, -0.373, JAR04_WOA)),
         JAR05_WOA = ifelse(is.na(JAR05_WOA), NA,
...
older <- older %>%
  mutate(JAR01_WOA = ifelse(is.na(JAR01_WOA), NA,
                             ifelse(JAR01_WOA > 1.528, 100, JAR01_WOA)),
         JAR01_WOA = ifelse(is.na(JAR01_WOA), NA,
                             ifelse(JAR01_WOA < 0.226, -100, JAR01_WOA))) ## No outliers
...
older <- older %>%
  mutate(JAR04_WOA = ifelse(is.na(JAR04_WOA), NA,
                             ifelse(JAR04_WOA > 1.811, 100, JAR04_WOA)),
         JAR04_WOA = ifelse(is.na(JAR04_WOA), NA,
                             ifelse(JAR04_WOA < -0.487, -100, JAR04_WOA))) ## No outliers
...
youngmsd_Qs <- young %>% 
  get_summary_stats(DASS, AVFLUIDIQ, type = "mean_sd")
