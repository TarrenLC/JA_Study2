...
model37 <- lmer(WOA~GMC_AGE*GMC_FLUIDIQ + GMC_DASS*EMO_REG_TYPE + GMC_PRE_CONF + GMC_PERCEIVED_ACC +
                  (1|ID), data = ja_df4,  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))

anova(model29, model37)

model38 <- lmer(WOA~GMC_AGE + EMO_REG_TYPE*GMC_FLUIDIQ + GMC_DASS*EMO_REG_TYPE + GMC_PRE_CONF + GMC_PERCEIVED_ACC +
                  (1|ID), data = ja_df4,  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))

anova(model29, model38)

model39 <- lmer(WOA~GMC_AGE + EMO_REG_TYPE*GMC_PRE_CONF + GMC_DASS*EMO_REG_TYPE + GMC_FLUIDIQ + GMC_PERCEIVED_ACC +
                  (1|ID), data = ja_df4,  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))

anova(model29, model39)

model40 <- lmer(WOA~GMC_AGE + EMO_REG_TYPE*GMC_PERCEIVED_ACC + GMC_DASS*EMO_REG_TYPE + GMC_FLUIDIQ + GMC_PRE_CONF +
                  (1|ID), data = ja_df4,  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))

anova(model29, model40)

model41 <- lmer(WOA~GMC_AGE*EMO_REG_TYPE*GMC_DASS*GMC_FLUIDIQ + GMC_PERCEIVED_ACC + GMC_PRE_CONF +
                  (1|ID), data = ja_df4,  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))

anova(model29, model41)
