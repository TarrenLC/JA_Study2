...
contingency_table <- table(ja_df4$AGEGROUP, ja_df4$EMO_REG_TYPE)
## contingency_table <- melt(contingency_table, na.rm = FALSE, id = 'EMO_REG_TYPE') ## Still made a 3x3 table which will not work 
contingency_table

## pairwise.prop.test(contingency_table) ## Will not work due to there being more than 2 columns


chisq.posthoc.test(contingency_table) # Works with more than 2 columns
