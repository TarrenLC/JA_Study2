...
ja_df4 <- ja_df4 %>% mutate(GMC_PRE_CONF = scale(PRE_CONFIDENCEn, scale = FALSE)) 


ja_df4 <- ja_df4 %>% mutate(GMC_POST_CONF = scale(POST_CONFIDENCEn,scale=FALSE))
...
model25 <- lmer(WOA~GMC_AGE + GMC_DASS + GMC_CONFIDENCE*CONFIDENCE_TIME +
...
model26 <- lmer(WOA~GMC_DASS + CONFIDENCE_TIME*GMC_CONFIDENCE*GMC_AGE +
                  (1|ID), data = ja_df4,  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
model27 <- lmer(WOA~GMC_AGE + CONFIDENCE_TIME*GMC_CONFIDENCE*GMC_DASS +
                  (1|ID), data = ja_df4,  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
