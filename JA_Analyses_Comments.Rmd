...
model13 <- lmer(WOA~EMO_EFFORT*REGULATION_TYPE +
                  (1|ID), data = emodf, control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
model14 <- lmer(WOA~EMO_EFFORT + GMC_DASS +
                  (1|ID), data = emodf, control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
model15 <- lmer(WOA~EMO_EFFORT*GMC_DASS +
                  (1|ID), data = emodf, control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
model16 <- lmer(WOA~EMO_EFFORT + GMC_AGE +
                  (1|ID), data = emodf, control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))

anova(model11, model16)

model17 <- lmer(WOA~EMO_EFFORT*GMC_AGE +
                  (1|ID), data = emodf, control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))

anova(model16, model17)

model18 <- lmer(WOA~EMO_EFFORT + GMC_FLUIDIQ +
                  (1|ID), data = emodf, control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))

anova(model11, model18)

model19 <- lmer(WOA~EMO_EFFORT*GMC_FLUIDIQ +
                  (1|ID), data = emodf, control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
model16 <- lmer(WOA~GMC_AGE + GMC_DASS + EMO_EFFORT + GMC_FLUIDIQ +
                  (1|ID), data = emodf, control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))


model17 <- lmer(WOA~GMC_AGE + GMC_DASS + EMO_EFFORT*GMC_FLUIDIQ +
                  (1|ID), data = emodf, control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))

summary(model16, model17)

model18 <- lmer(WOA~GMC_AGE + GMC_DASS + EMO_EFFORT + REGULATION_TYPE + GMC_FLUIDIQ +
                  (1|ID), data = emodf, control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))

model19 <- lmer(WOA~GMC_AGE + GMC_DASS + EMO_EFFORT + REGULATION_TYPE*GMC_FLUIDIQ +
                  (1|ID), data = emodf, control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))

anova(model18, model19)

anova(model16, model19)
...
ja_df4 <- ja_df4 %>% mutate(GMC_PRE_CONF = scale(PRE_CONFIDENCEn, center = TRUE, scale = FALSE)) 

# Create grand mean centered confidence
ja_df4 <- ja_df4 %>% mutate(GMC_CONFIDENCE= scale(PM_CONFIDENCE,scale=FALSE))


# Grand mean center perceived advice accuracy
ja_df4 <- ja_df4 %>% mutate(GMC_PERCEIVED_ACC = scale(PERCEIVED_ADVICE_ACCURACYn, scale = FALSE))
...
# Main effects only
model20 <- lmer(WOA~GMC_AGE + GMC_DASS + GMC_CONFIDENCE + CONFIDENCE_TIME + 
                  (1|ID), data = ja_df4,  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))

summary(model20)

model21 <- lmer(WOA~GMC_AGE + GMC_DASS + GMC_CONFIDENCE*CONFIDENCE_TIME +
                  (1|ID), data = ja_df4,  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
model22 <- lmer(WOA~GMC_DASS + CONFIDENCE_TIME*GMC_CONFIDENCE*GMC_AGE +
                  (1|ID), data = ja_df4,  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
model23 <- lmer(WOA~GMC_AGE + CONFIDENCE_TIME*GMC_CONFIDENCE*GMC_DASS +
                  (1|ID), data = ja_df4,  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
